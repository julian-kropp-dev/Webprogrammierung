...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $formId = FormName::FORUM_POST_EDIT->name . "-" . $post_id;
    ...
    if ($_SESSION["user_id"] !== $entry->getCreator()) {
        $_SESSION["message"] = "Du bist nicht Autor des Beitrages";
        header($redirect_header);
        exit;
    }
    try {
        $forum_manager->updateForumEntry($post_id, $_SESSION["user_id"], $_POST["title"], $_POST["tag"], $_POST["description"]);

...
<p>Andere Daten werden automatisch oder nach Ihrer Einwilligung beim Besuch der Website durch unsere IT-Systeme erfasst.
    ...
    Erfassung dieser Daten erfolgt automatisch, sobald Sie diese Website betreten.</p> <h4>Wof&uuml;r nutzen wir Ihre
    Daten?</h4>
<p>Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gew&auml;hrleisten. Andere Daten k&ouml;nnen
    zur Analyse Ihres Nutzerverhaltens verwendet werden.</p> <h4>Welche Rechte haben Sie bez&uuml;glich Ihrer
    Daten?</h4>
...
<h2>2. Hosting</h2>
<p>Wir hosten die Inhalte unserer Website auf internen Servern.</p>
...
<p>Wenn Sie diese Website benutzen, werden verschiedene personenbezogene Daten erhoben. Personenbezogene Daten sind
    Daten, mit denen Sie pers&ouml;nlich identifiziert werden k&ouml;nnen. Die vorliegende Datenschutzerkl&auml;rung erl&auml;utert,
...
<p>Telefon: 34567876543456<br/>
    E-Mail: mustermann@test.de</p>
...
<p>Sofern Sie in die Datenverarbeitung eingewilligt haben, verarbeiten wir Ihre personenbezogenen Daten auf Grundlage
    ...
    Abs. 1 TDDDG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserf&uuml;llung oder zur Durchf&uuml;hrung
    vorvertraglicher Ma&szlig;nahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage des Art. 6 Abs. 1 lit. b
    DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern diese zur Erf&uuml;llung einer rechtlichen Verpflichtung
    erforderlich sind auf Grundlage von Art. 6 Abs. 1 lit. c DSGVO. Die Datenverarbeitung kann ferner auf Grundlage
    unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO erfolgen. &Uuml;ber die jeweils im Einzelfall
...
<p>Sie haben das Recht, die Einschr&auml;nkung der Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Hierzu k&ouml;nnen
    Sie sich jederzeit an uns wenden. Das Recht auf Einschr&auml;nkung der Verarbeitung besteht in folgenden F&auml;llen:</p>
<ul>
...
<p>F&uuml;r die Kommentarfunktion auf dieser Seite werden neben Ihrem Kommentar auch Angaben zum Zeitpunkt der
...
<p>Die Kommentare und die damit verbundenen Daten werden gespeichert und verbleiben auf dieser Website, bis der
    kommentierte Inhalt vollst&auml;ndig gel&ouml;scht wurde oder die Kommentare aus rechtlichen Gr&uuml;nden gel&ouml;scht
    werden m&uuml;ssen (z.&nbsp;B. beleidigende Kommentare).</p>
<h4>Rechtsgrundlage</h4>
<p>Die Speicherung der Kommentare erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). Sie k&ouml;nnen
    eine von Ihnen erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose Mitteilung per E-Mail an uns.
    Die Rechtm&auml;&szlig;igkeit der bereits erfolgten Datenverarbeitungsvorg&auml;nge bleibt vom Widerruf unber&uuml;hrt.</p>
<h2>5. Plugins und Tools</h2>
<h3>Google reCAPTCHA</h3>
<p>Wir nutzen &bdquo;Google reCAPTCHA&ldquo; (im Folgenden
...
<p>Mit reCAPTCHA soll &uuml;berpr&uuml;ft werden, ob die
    ...
    erfassten Daten werden an Google weitergeleitet.</p>
<p>Die reCAPTCHA-Analysen laufen vollst&auml;ndig im
    Hintergrund. Websitebesucher werden nicht darauf hingewiesen, dass eine Analyse stattfindet.</p>
<p>Die
...
<h3>FlickR API</h3>
<p>
    Wir nutzen die FlickR API, um unseren Benutzern die Möglichkeit zu bieten, nach Bildern zu suchen und diese in
    Forenbeiträge einzufügen. Dabei werden folgende Daten erfasst und verarbeitet:
</p>
<p>
    Art der Daten:
    Es werden die IP-Adresse, Suchanfragen und die daraus resultierenden Suchergebnisse sowie Informationen über die
    Verwendung der Bilder (z.B. welche Bilder ausgewählt und in Beiträge eingefügt werden) erfasst.
</p>
<p>
    Zweck der Verarbeitung:
    Die Daten werden verarbeitet, um die Funktion der Bildersuche und -einbindung bereitzustellen und zu verbessern.
</p>
<p>
    Rechtsgrundlage:
...
<p>
    Datenempfänger:
    Die erhobenen Daten werden an die Server von FlickR (betrieben durch SmugMug, Inc.) übertragen, um die Bildersuche
    zu ermöglichen.
</p>
<p>
    Datenübertragung:
    FlickR ist ein Dienst, der von SmugMug, Inc. mit Sitz in den USA betrieben wird. Die Datenübertragung in die USA
    erfolgt auf Grundlage des EU-US Data Privacy Frameworks (DPF), das sicherstellt, dass Ihre Daten gemäß europäischen
    Datenschutzstandards geschützt werden.
</p>
<p>
    Speicherdauer:
    Die Daten werden nur so lange gespeichert, wie es für den Zweck der Verarbeitung erforderlich ist. Die Dauer der
    Speicherung auf den Servern von FlickR unterliegt den Datenschutzbestimmungen von FlickR.
</p>
